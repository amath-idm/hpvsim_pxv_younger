...
def make_sim(location=None, calib_pars=None, debug=0, screen_intv=None, vx_intv=None,
             analyzers=[], datafile=None, seed=1, econ_analyzer=False, end=2020, n_agents=10e3,
...
def run_sim(
        location=None, screen_intv=None, vx_intv=None, analyzers=None, debug=0, seed=1, verbose=0.2,
        do_save=False, dist_type='lognormal', marriage_scale=1, debut_bias=[0, 0], econ_analyzer=False, end=2020, n_agents=10e3,
        calib_pars=None, meta=None
):
    if analyzers is None:
        analyzers = sc.autolist()
    else:
...
if __name__ == '__main__':
    ...
    sim = run_sim(location=location, calib_pars=calib_pars, end=2032,
                  vx_intv=dict(
                      vx_coverage=0.5,
                      age_range=(9, 14),
                      infant=True,
